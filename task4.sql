...
insert into supermarket.shops (shop_address, supervisor_email)
...
insert into supermarket.warehouses (warehouse_address, supervisor_email)
...
insert into supermarket.suppliers (supplier_name, supplier_email)
...
insert into supermarket.products (product_name, product_price, product_manufacturer)
...
insert into supermarket.supplies_wareh(warehouse_id, supplier_id, supply_date)
...
insert into supermarket.supplies_shop(warehouse_id, shop_id, supply_date)
...
insert into supermarket.prods_supply_wareh
values (1, 1, 100),
       (1, 2, 50),
       (2, 4, 30),
       (2, 5, 70),
...
insert into supermarket.prods_supply_shop
values (4, 1, 30),
       (4, 2, 30),
       (1, 1, 20),
       (1, 3, 20),
...
insert into supermarket.purchases (card_phone, shop_id, purchase_date)
...
insert into supermarket.prods_purchase
values (1, 1, 2),
       (2, 3, 1),
       (3, 3, 4),
       (4, 2, 4),
...
insert into supermarket.prods_wareh
...
insert into supermarket.prods_shop
...
from ((select A.shop_id, B.product_id, sum(B.product_quantity) as summ
       from supermarket.supplies_shop as A
                join supermarket.prods_supply_shop as B on A.supply_shop_id = B.supply_shop_id
       group by A.shop_id, B.product_id) as INCOME
    left join (select D.shop_id, E.product_id, sum(E.product_quantity) as summ
               from supermarket.purchases as D
                        join supermarket.prods_purchase E on D.purchase_id = E.purchase_id
